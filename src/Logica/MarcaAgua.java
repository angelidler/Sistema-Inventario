 ...
 * @author Tecnico
 */
public class MarcaAgua extends JLabel implements FocusListener, DocumentListener{
	...
	public MarcaAgua(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public MarcaAgua(String text, JTextComponent component, Show show) {
